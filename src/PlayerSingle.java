...
public class PlayerSingle implements Serializable, PlayerInterface {
    private final String __name;
    private final WordsGameSinglePlayerInterface __game_stub;
    private final Scanner __sc;

    public PlayerSingle(String name, WordsGameSinglePlayerInterface game_stub) {
        __name = name;
    ...
    public void RequestWord() throws RemoteException {
        ...
        WordsGameSinglePlayerInterface.ValidationResponse response = null;
        while (response != WordsGameSinglePlayerInterface.ValidationResponse.PASSED && response != WordsGameSinglePlayerInterface.ValidationResponse.TIME_OUT && response != WordsGameSinglePlayerInterface.ValidationResponse.FORCE_EXIT) {
